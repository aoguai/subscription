...
const globalGroups: RawGlobalGroup[] = [
  ...
  },
  {
    ...
    rules: [
      {
        key: 0,
        matches: `[(((vid^="ad"||vid^="AD"||vid$="ad"||vid$="Ad"||vid$="AD")&&vid*="_")||vid="adIv"||vid*="_ad_"||vid*="_Ad_"||vid*="_AD_")&&(vid!*="load"&&vid!*="Load"&&vid!*="LOAD")&&(vid!*="read"&&vid!*="Read"&&vid!*="READ")&&(vid!*="add"&&vid!*="Add"&&vid!*="ADD")&&(vid!*="ead"&&vid!*="EAD")][height>0&&width>0] <<n * <n * > * >n ${NEGATION_PART_RULE_BUTTON}`,
      },
      {
        key: 1,
